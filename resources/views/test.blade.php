...
$(document).ready(function() {
    ...
    $("#etd").click(function() {
        ...
        $('#spec').remove();
        $('#add').after("<div id=\"key\" class=\"form-group row\"><label for=\"key\" class=\"col-md-4 col-form-label text-md-right\">{{ __('Class Key') }}</label><div class=\"col-md-6\"><input id=\"key\" type=\"text\" class=\"form-control @error('spec') is-invalid @enderror\" name=\"key\"  required autocomplete=\"key\" autofocus required value=\"NULL\"> @error('key') <span class=\"invalid-feedback\" role=\"alert\">             <strong>{{ $message }}</strong>    </span>    @enderror  </div></div>");
