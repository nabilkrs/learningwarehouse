            ...
            @if (Route::has('login'))
                <div class="top-right links">
                    ...
                    @else
                       ...
                       <a href="{{ route('login') }}" style="text-decoration:none"><div style="color:black;display:inline;">Login</div></a>
                        @if (Route::has('register'))

                          <a href="{{ route('register') }}" style="text-decoration:none" ><div style="color:black;display:inline;">Register</div></a>
