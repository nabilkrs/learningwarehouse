...
<div class="container" id="container">
	<div class="form-container sign-up-container">
        ...
        @csrf
           ...
           <input id="photo" placeholder="photo" type="file" name="photo" value="C:\xampp\htdocs\projet\public\photo\unknown.jpg">
...
<div class="controls">
<label class="radio">
<input type="radio" required name="option" value="Etudiant" id="etd">
    Student
  </label>
<div style="width:30px"></div>
  <label class="radio">
  <input type="radio" name="option" required  value="Enseignant" id="ens">
    Teacher
  </label>
			...
			<input id="password" autocomplete="new-password" class="form-control @error('password') is-invalid @enderror" type="password" name="password" placeholder="Password" required />
            @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong style="color:red">{{ $message }}</strong>
                                    </span>
